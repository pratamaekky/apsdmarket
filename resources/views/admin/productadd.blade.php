                ...
                <div class="col-12 row">
                    <div class="col-6">
                        <div class="form-group">
                            <label>SKU</label>
                            <input type="text" name="sku" class="form-control form-control-user" id="inputSku" placeholder="Enter SKU..." value="{{ old('sku') }}">
                            @if ($errors->has('sku'))
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control form-control-user" id="inputType" placeholder="Enter Type...">
                                ...
                                <option value="1" {{ old('type') == "1" ? "selected" : "" }}>Food & Beverage</option>
                                <option value="2" {{ old('type') == "2" ? "selected" : "" }}>Retail</option>
                            </select>
                            @if ($errors->has('type'))
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" name="price" class="form-control form-control-user" id="inputPrice" placeholder="Enter Price..." value="{{ old('price') }}">
                            @if ($errors->has('price'))
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control form-control-user" id="inputDescription" placeholder="Enter Description..." value="{{ old('description') }}" style="height: 7.75rem"></textarea>
